<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Add Production</h6>
            </nav>
        ...
        <div class="card-header card-header-primary">
            <div class="row">
                <div class="col-7 align-items-center pl-4">
                    <h4 class="mb-0">Create Production Data</h4>
                    <span class="text-sm mb-0 text-end">Form to create data</span>
                </div>
            </div>
            <div class="d-flex pt-4" method="post">
                <div class="col-8">
                    <div class="card border-0 d-flex p-4 pt-0 mb-2 bg-gray-100">
                    <form class="pt-4" action="<?= site_url('leader/addShiftment'); ?>" method="post">
                    
                            <span>Staff Head</span></br>
                            <div class="input-group input-group-dynamic mb-4">
                                <select class="selectpicker form-control text-md"name="id_plan" data-style="btn btn-primary btn-round" data-live-search="true">
                                    <option disabled selected>Select your production</option>
                ...
                <div class="col-4">
                    ...
                    <div class="d-flex">
                        <div class="pt-2 pl-2">
                            <a class="btn btn-outline-dark btn-sm mb-0" href="<?= site_url('leader/plan_shift'); ?>">Back</a>
                        </div>
                        <div class="pt-2 pl-2">
