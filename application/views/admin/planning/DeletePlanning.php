<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                ...
                <h6 class="font-weight-bolder mb-0">Delete Planning</h6>
            </nav>
        ...
        <div class="card-header card-header-primary">
            <div class="row">
                <div class="col-7 align-items-center pl-4">
                    <h4 class="mb-0">Delete Planning Data</h4>
                    <span class="text-sm mb-0 text-end">Form to delete planning</span>
                </div>
            </div>
            <div class="d-flex pt-4" method="post">
                <div class="col-8">
                    <div class="card border-0 d-flex p-4 pt-0 mb-2 bg-gray-100">
                    <form class="pt-4" action="<?= site_url('admin/deletePlanning/'.$detail['id_plan']); ?>" method="post">
                    <div class="row d-flex">
                        <div class="col-5">
                            ...
                            <div class="input-group input-group-dynamic mb-4">
                                ...
                                <input type="text" disabled selected name="plan_name" value="<?= $detail['plan_name']?>" class="form-control">
                            </div>
                        </div>
                        <div class="col-2">
                    ...
                    <div class="row d-flex pt-4">
                            <div class="col-5">
                                ...
                                <div class="input-group input-group-dynamic mb-4">
                                    <label class="form-label"></label>
                                    <input type="number" disabled selected value="<?= $detail['qty_target']?>" name="qty_target" class="form-control">
                                </div>
                            </div>
                            <div class="col-2">
                            </div>
                            <div class="col-5 pl-3">
                                ...
                                <div class="input-group input-group-dynamic mb-4">
                                    <label class="form-label"></label>
                                    <input type="date" disabled selected value="<?= $detail['end_date']?>" name="end_date" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
