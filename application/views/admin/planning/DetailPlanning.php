    ...
    <div class="pb-4">
        <div class="row">
            ...
            <div class="col-2 text-end d-flex">
                <div class="pl-2 pr-3">
                <a href="<?= site_url('admin/planning/'.$plan['id_plan'].'/update'); ?>" rel="tooltip" title="detail"  class="btn btn-info btn-sm mb-0">Update</a>
                </div>
            </div>
        </div>
    </div>
          ...
          <div class="card h-100">
            ...
            <div class="row">
                ...
                <div class="col-6 text-end">
                    <a href="<?= site_url('admin/plan_shift/addshiftment'); ?>" class="btn btn-outline-dark btn-sm mb-0">Add Shiftment</a>
                </div>
            </div>
            <hr>
