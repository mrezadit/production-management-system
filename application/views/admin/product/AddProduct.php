            ...
            <div class="d-flex pt-4" method="post">
                <div class="col-8">
                    ...
                    <form class="pt-4" action="<?= site_url('admin/addProduct'); ?>" method="post">
                        ...
                        <span>Product Application</span></br>
                        <div class="input-group input-group-dynamic mb-4">
                            <label class="form-label"></label>
                            <textarea type="textarea" name="application" class="form-control"></textarea>
                        </div>
                    </div>
                </div>
                <div class="col-4">
                    <div class="p-2">
                        <span>Create and save this data customer?</span></br>
                    </div>
                    <div class="d-flex">
                        <div class="pt-2 pl-2">
                            <a class="btn btn-outline-dark btn-sm mb-0" href="<?= site_url('admin/product'); ?>">Back</a>
                        </div>
                        <div class="pt-2 pl-2">
