        ...
        <div class="card-header card-header-primary">
            <div class="row">
                <div class="col-7 align-items-center pl-4">
                    <h4 class="mb-0">Delete Project Data</h4>
                    <span class="text-sm mb-0 text-end">Form to delete project data</span>
                </div>
            </div>
            <div class="d-flex pt-4" method="post">
                <div class="col-8">
                    <div class="card border-0 d-flex p-4 pt-0 mb-2 bg-gray-100">
                    <form class="pt-4" action="<?= site_url('admin/deleteProject/'.$detail['id_project']); ?>" method="post">
                        ...
                        <div class="row d-flex">
                            <div class="col-4">
                                ...
                                <div class="input-group input-group-dynamic mb-4">
                                    ...
                                    <input disabled selected type="text"  name="project_name" value="<?= $detail['project_name']?>" class="form-control">
                                </div>
                            </div>
                            <div class="col-1">
                            </div>
                            ...
                            <div class="input-group input-group-dynamic mb-4">
                                <label class="form-label"></label>
                                <input type="date" disabled selected name="entry_date" value="<?= $detail['entry_date']?>" class="form-control">
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="input-group input-group-dynamic mb-4">
                            <select class="selectpicker form-control" name="id_cust" data-style="btn btn-link" data-live-search="true">
                                ...
                                <?php if (!empty($customer)) : $i = 1; foreach ($customer as $value) : ?>
                                    <option disabled selected value="<?= $value->id_cust; ?>" <?= $detail['id_cust'] === $value->id_cust ? 'selected' : ''; ?> ><?= $value->cust_name; ?></option> 
                        ...
                        <div class="input-group input-group-dynamic mb-4">
                            <select class="selectpicker form-control" name="id_product" data-style="btn btn-link" data-live-search="true">
                                ...
                                <?php if (!empty($product)) : $i = 1; foreach ($product as $value) : ?>
                                    <option disabled selected value="<?= $value->id_product; ?>" <?= $detail['id_product'] === $value->id_product ? 'selected' : ''; ?>><?= $value->product_name; ?></option> 
                                <?php endforeach; endif; ?>
                            </select>    
                        </div>
                        <div class="row d-flex">
                            <div class="col-5">
                                ...
                                <div class="input-group input-group-dynamic mb-4">
                                    <label class="form-label"></label>
                                    <input type="text" disabled selected name="qty_request" value="<?= $detail['qty_request']?>" class="form-control">
                            ...
                            <div class="col-5 pl-3">
                                ...
                                <div class="input-group input-group-dynamic mb-4">
                                    <label class="form-label"></label>
                                    <input type="text" disabled selected name="diameter" value="<?= $detail['diameter']?>" class="form-control">
                ...
                <div class="col-4">
                    <div class="pr-2">
                        <span>Do you really want to delete this project data?</span></br>
                    </div>
                    <div class="d-flex">
                        <div class="pt-2 pl-2">
