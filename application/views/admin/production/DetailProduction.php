    ...
    <div class="pb-4">
        <div class="row">
            ...
            <div class="col-2 text-end d-flex">
                <div class="pl-4">
                <a href="<?= site_url('admin/detail_production/'.$detail['id_planshift'].'/addsorting'); ?>"class="btn btn-info btn-sm mb-0">COMPLETE</a>
                </div>
            </div>
        </div>
    </div>
              ...
              <div class="card mt-4">
                <div class="card-header pb-0 p-3">
                    <div class="row">
                        ...
                        <div class="col-4 text-end">
                            <a href="<?= site_url('admin/material/addmaterial'); ?>" class="btn btn-outline-dark btn-sm mb-0">Add Material</a>
                        </div>
                    </div>
                </div>
                <div class="card-body p-3">
                <div class="table-responsive p-0">
                    ...
                    <?php if (!empty($p_material)) : $i = 1; foreach ($p_material as $value) : ?>
                        ...
                        <td class="">
                        <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="<?= site_url('admin/deleteMaterial/'.$value->id_pmaterial.'/'.$value->id_material); ?>"><i class="material-icons text-sm me-2">delete</i>Delete</a>
                        </td>
        ...
        <div class="col-lg-6">
          <div class="card pb-4">
            ...
            <div class="row">
                ...
                <div class="col-4 text-end">
                    <a href="<?= site_url('admin/machine/addmachine'); ?>" class="btn btn-outline-dark btn-sm mb-0">Add Machine</a>
                </div>
            </div>
            ...
            <div class="table-responsive p-0">
                    ...
                    <?php if (!empty($p_machine)) : $i = 1; foreach ($p_machine as $value) : ?>
                        ...
                        <?php if ( $value->mc_stats == 2) :?>
                            <a class="btn btn-link text-info text-gradient px-3 mb-0" href="<?= site_url('admin/finishMachine/'.$value->id_pmachine.'/'.$value->id_machine); ?>"><i class="material-icons text-sm me-2">logout</i>Finish</a>
