        ...
        <div class="card">
            ...
            <div class="table-responsive p-0">
                ...
                <?php if (!empty($production)) : $i = 1; foreach (array_reverse($production) as $value) : ?>
                    ...
                    <a href="<?= site_url('admin/detail_production/'.$value->id_planshift.'/view'); ?>" rel="tooltip" title="detail"  class="badge bg-gradient-info">Process</a>
                    <?php elseif ( $value->ps_status == 0) : ?>
                    <span href="<?= site_url('admin/detail_production/'.$value->id_planshift.'/view'); ?>" rel="tooltip" title="detail"  class="badge bg-gradient-secondary">Done</span>
                    <?php endif ;?> 
                    </td>
                    </tr>
