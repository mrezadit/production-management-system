        ...
        <div class="card-header card-header-primary">
            <div class="row">
                <div class="col-7 align-items-center pl-4">
                    <h4 class="mb-0">Delete this Shiftment Data</h4>
                    <span class="text-sm mb-0 text-end">Form to delete data</span>
                </div> 
            </div>
            <div class="d-flex pt-4" method="post">
                <div class="col-8">
                    <div class="card border-0 d-flex p-4 pt-0 mb-2 bg-gray-100">
                    <form class="pt-4" action="<?= site_url('admin/deleteShiftment/'.$detail['id_planshift'].'/'.$detail['id_staff']); ?>" method="post">
                        <div class="row d-flex">
                                ...
                                <div class="input-group input-group-dynamic mb-4">
                                    <select class="selectpicker form-control" name="id_plan" data-style="btn btn-link" data-live-search="true">
                                        ...
                                        <?php if (!empty($planning)) : $i = 1; foreach ($planning as $value) : ?>
                                            <option value="<?= $value->id_plan; ?>" <?= $detail['id_plan'] === $value->id_plan ? 'selected' : ''; ?> ><?= $value->plan_name; ?></option> 
                            ...
                            <div class="input-group input-group-dynamic mb-4">
                                ...
                                <input type="date" name="start_date" value="<?= $detail['start_date']; ?>" class="form-control">
                            </div>
                            </div>
                        </div>
                        <div class="row d-flex">
                                ...
                                <div class="input-group input-group-dynamic mb-4">
                                    <select class="selectpicker form-control" name="id_shift" data-style="btn btn-link" data-live-search="true">
                                        ...
                                        <?php if (!empty($shiftment)) : $i = 1; foreach ($shiftment as $value) : ?>
                                            <option value="<?= $value->id_shift; ?>" <?= $detail['id_shift'] === $value->id_shift ? 'selected' : ''; ?> ><?= $value->shift_name; ?></option> 
                                        <?php endforeach; endif; ?>
                                    </select>                      
                                </div>
                            </div>
                            ...
                            <div class="input-group input-group-dynamic mb-4">
                                    <select class="selectpicker form-control" name="id_staff" data-style="btn btn-link" data-live-search="true">
                                        ...
                                        <?php if (!empty($staff)) : $i = 1; foreach ($staff as $value) : ?>
                                            <option value="<?= $value->id_staff; ?>" <?= $detail['id_staff'] === $value->id_staff ? 'selected' : ''; ?> ><?= $value->staff_name; ?></option> 
                                        <?php endforeach; endif; ?>
                                    </select>      
                            </div>
                            </div>
